 ...
 * @generated
 */
public class IssuerSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IssuerPackage.ISSUER: {
				Issuer issuer = (Issuer)theEObject;
				T result = caseIssuer(issuer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IssuerPackage.PRODUCT: {
				Product product = (Product)theEObject;
				T result = caseProduct(product);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IssuerPackage.VERSION: {
				Version version = (Version)theEObject;
				T result = caseVersion(version);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IssuerPackage.TEAM: {
				Team team = (Team)theEObject;
				T result = caseTeam(team);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IssuerPackage.DEVELOPER: {
				Developer developer = (Developer)theEObject;
				T result = caseDeveloper(developer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IssuerPackage.ISSUE: {
				Issue issue = (Issue)theEObject;
				T result = caseIssue(issue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IssuerPackage.BUG: {
				Bug bug = (Bug)theEObject;
				T result = caseBug(bug);
				if (result == null) result = caseIssue(bug);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IssuerPackage.ENHANCEMENT: {
				Enhancement enhancement = (Enhancement)theEObject;
				T result = caseEnhancement(enhancement);
				if (result == null) result = caseIssue(enhancement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IssuerPackage.COMMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bug</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bug</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBug(Bug object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Enhancement</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Enhancement</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEnhancement(Enhancement object) {
		return null;
	}
